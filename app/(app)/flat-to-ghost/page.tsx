      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        {lightbox !== null && (
          <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/90 px-4">
            ...
            <a href={results[lightbox]} download={`liora-ghost-${lightbox + 1}.png`} className="mt-6 inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-medium text-[#0a0a0a]">

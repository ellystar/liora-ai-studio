...
export default function MesafeliSatisPage() {
  return (
    ...
    >
      ...
      <LegalP>
        <strong>3.3.</strong> Ödemeler, <strong>PayTR Ödeme ve Elektronik Para Kuruluşu A.Ş.</strong> güvenli ödeme altyapısı üzerinden kredi kartı/banka kartı ile tahsil edilir. ALICI&apos;nın kart bilgileri SATICI tarafından görüntülenmez ve saklanmaz.
      </LegalP>
      <LegalP>
